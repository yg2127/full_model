...
def main() -> None:
    ...
    ap.add_argument('--root', default='/data/shared/scuppy/hyi/Compare/Compare_Spatiotemporal')
    ap.add_argument('--tag', default='spatiotemporal_dms')
    ...
    df.to_csv(out_dir / 'spatiotemporal_dms_seed_results_raw.csv', index=False, encoding='utf-8-sig')
    ...
    agg.to_csv(out_dir / 'spatiotemporal_dms_seed_results_mean_std.csv', index=False, encoding='utf-8-sig')

    print('[SAVED]', out_dir / 'spatiotemporal_dms_seed_results_raw.csv')
    print('[SAVED]', out_dir / 'spatiotemporal_dms_seed_results_mean_std.csv')
