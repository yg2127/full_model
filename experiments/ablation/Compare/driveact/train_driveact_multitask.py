...
try:
    from driveact_multitask import DriveActDMDMultitaskClassifier as DMDOriginalMultitaskClassifier
except ModuleNotFoundError:
    from .driveact_multitask import DriveActDMDMultitaskClassifier as DMDOriginalMultitaskClassifier


DEFAULT_CLASSIFICATION_ROOT = "/data/shared/scuppy/Classification_model_V1"
DEFAULT_CONFIG = str(THIS_DIR / "configs" / "driveact_seed42_gaze045_light.yaml")
...
def main(config_path: str):
    ...
    log = shared["get_logger"]("driveact_baseline_train", log_file=save_root / "train.log")
    ...
    if masked_drop:
        ...
        drop_rows = []
        for head, metric_map in masked_drop.items():
    ...
    summary = {
        "baseline_name": "driveact_multitask",
