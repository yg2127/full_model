...
def main() -> None:
    ...
    ap.add_argument('--root', default='/data/shared/scuppy/hyi/Ablation/AblationB')
    ...
    df.to_csv(out_dir / 'ablation_b_seed_results_raw.csv', index=False, encoding='utf-8-sig')
    ...
    agg.to_csv(out_dir / 'ablation_b_seed_results_mean_std.csv', index=False, encoding='utf-8-sig')

    print('[SAVED]', out_dir / 'ablation_b_seed_results_raw.csv')
    print('[SAVED]', out_dir / 'ablation_b_seed_results_mean_std.csv')
